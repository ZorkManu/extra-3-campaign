...
function WavesP1()
    if Modulo(math.max(1,TICK-15),300-Difficulties[1]*60) == 0 then
...
function WavesP2()
    if Modulo(math.max(1,TICK-5),300-Difficulties[2]*60) == 0 then
        if SPECIALSACTIVE == 1 then
...
function WavesP3()
    if Modulo(math.max(1,TICK+15),300-Difficulties[3]*60) == 0 then
        if SPECIALSACTIVE == 1 then
...
function WavesP4()
    if Modulo(TICK-30,300-Difficulties[4]*60) == 0 then
        if SPECIALSACTIVE == 1 then
...
function createSpecialUnitBossWave1()
    ...
    CreateMilitaryGroup(8,Entities.CU_Evil_Troll1,0, pos, randomName)
...
function createTownBossWave()
    ...
    for i = 1, Difficulties[4] * 3 + 10 do
        waveArmy:CreateLeaderForArmy(getRandomGhostTroop(), 4, GetPosition("grave13"), 2)
    end
    for i = 1, Difficulties[4] * 2 do
...
function lastWaveCountdown1()
    ...
    if Counter.GetTick("lastWaveCountdown1") == 35 then
        ...
        CreateMilitaryGroup(8, Entities.PU_Hero4_Spectral, 0, GetPosition("grave10"), "ghosterec")
    end
end
...
function lastWaveCountdown2()
    ...
    if Counter.GetTick("lastWaveCountdown2") == 53 then
        ...
        CreateMilitaryGroup(8, Entities.PU_Hero2_Spectral, 0, GetPosition("nvspawn3"), "ghostpilgrim")
    end
end
...
function lastWaveCountdown3()
    ...
    if Counter.GetTick("lastWaveCountdown3") == 55 then
        ...
        CreateMilitaryGroup(8, Entities.PU_Hero5_Spectral, 0, GetPosition("grave13"), "ghostari")
    end
end
...
function lastWaveCountdown4()
    ...
    if Counter.GetTick("lastWaveCountdown4") == 57 then
        ...
        CreateMilitaryGroup(8, Entities.PU_Hero10_Spectral, 0, GetPosition("graveyard24"), "ghostdrake")
    end
end
...
function createNecro(_playerId)
    ...
    CreateMilitaryGroup(8,Entities.CU_Evil_Queen,0,GetPosition(pos), "necro" .. necroId)
...
function createErebos(_playerId)
    ...
    CreateMilitaryGroup(8,Entities.PU_Hero14,0,GetPosition("nvspawn" .. pos), "ere" .. EREBOSID)
...
function controlNecro(_pId, _necroId)
    ...
    if AreEnemiesInArea(8,GetPosition(name),600) then
